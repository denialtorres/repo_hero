...
/** Autogenerated input type of AddRepo */
...
export type MutationAddRepositoryCategoryArgs = {
  input: AddRepositoryCategoryInput;
};
...
/** Autogenerated input type of addRepositoryCategory */
export type AddRepositoryCategoryInput = {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    repository(variables: RepositoryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RepositoryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RepositoryQuery>(RepositoryDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'repository', 'query', variables);
    },
    repoWithReviews(variables: RepoWithReviewsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RepoWithReviewsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RepoWithReviewsQuery>(RepoWithReviewsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'repoWithReviews', 'query', variables);
    },
    repositories(variables?: RepositoriesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RepositoriesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RepositoriesQuery>(RepositoriesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'repositories', 'query', variables);
    }
  };
}
